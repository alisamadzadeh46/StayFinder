    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_title', models.CharField(blank=True, help_text='Custom SEO title (max 60 chars). Leave blank to auto-generate.', max_length=70)),
                ('meta_description', models.CharField(blank=True, help_text='Custom meta description (max 155 chars). Leave blank to auto-generate.', max_length=160)),
